    ...
    <div class="card" style="width: 60%; margin-bottom: 70px">
    	<div class="card-body">
            ...
            <?php foreach ($siswa as $sis) : ?>
        		<form method="POST" action="<?php echo base_url('admin/dataSiswa/updateDataAksi') ?>">

        			<div class="form-group">
        				<label>NISN</label>
                        <input type="text" name="nisn" class="form-control" value="<?php echo $sis->nisn ?>">
        				<?php echo form_error('nisn','<div class="text-small text-danger"></div>') ?>
        			</div>

        			<div class="form-group">
        				<label>NIS</label>
        				<input type="text" name="nis" class="form-control" value="<?php echo $sis->nis ?>">
        			...
        			<div class="form-group">
                        ...
                        <option value="<?php echo $sis->nama_kelas ?>"><?php echo $sis->nama_kelas ?></option>

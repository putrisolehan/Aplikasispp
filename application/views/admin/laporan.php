...
<div class="card mx-auto" style="width: 35%">
	...
	<form method="POST" action="<?php echo base_url('admin/laporan/cetakLaporan') ?>">
		<div class="card-body">
		   		...
		   		<button style="width: 100%" type="submit" class="btn btn-info"><i class="fas fa-print"></i>Cetak Laporan</button>
		</div>
	</form>
</div>
</div>
